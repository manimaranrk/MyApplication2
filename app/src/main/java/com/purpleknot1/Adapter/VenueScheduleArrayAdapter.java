...
public class VenueScheduleArrayAdapter extends ArrayAdapter<ScheduleVenueListDto> {
    ...
    private List<ScheduleVenueListDto> scheduleVenueListDtos = new ArrayList<ScheduleVenueListDto>();
        ...
        public VenueScheduleArrayAdapter(Activity context, int textViewResourceId) {
