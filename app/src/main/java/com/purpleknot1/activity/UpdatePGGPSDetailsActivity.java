...
public class UpdatePGGPSDetailsActivity extends Activity  implements ConnectionCallbacks,
  ...
  //  private static final String TAG_SUCCESS = "success";
   ...
   // private TextView lblLocation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.update_pggpsdetail);

        venueNameEdittext=(EditText)findViewById(R.id.update_pg_name_edittext);

        venueNameEdittext.setFocusable(false);

        backImageView=(ImageView)findViewById(R.id.update_pg_back_imageview);
        ...
        if (extras != null) {
            venueNam = extras.getString("pgname");
        ...
        backImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(UpdatePGGPSDetailsActivity.this, ScheduledPgvgActivity.class);
    ...
    public void menuButtonClickEvent(View view){
        ...
        popupMenu = new PopupMenu(UpdatePGGPSDetailsActivity.this, view);
...
//    }
    ...
    class CheckValidUser extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(UpdatePGGPSDetailsActivity.this);
        ...
        protected JSONObject doInBackground(String... args) {
            ...
            if (networkConnection.isNetworkAvailable()) {
                ...
                pDialog.dismiss();
                Looper.prepare();
                Toast.makeText(UpdatePGGPSDetailsActivity.this,
        ...
        protected void onPostExecute(JSONObject json) {
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    Intent intent=new Intent(UpdatePGGPSDetailsActivity.this, LoginActivity.class);
    ...
    public void updateVenueButtonClick(View v) {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
                UpdatePGGPSDetailsActivity.this);
        ...
        // set dialog message
        alertDialogBuilder
                .setMessage("Please ensure Near by the PG/VG")
                .setCancelable(false)
    ...
    public void updateVenueGps(){
      ...
      //      Toast.makeText(UpdatePGGPSDetailsActivity.this, "Please Enter Venue Name.", Toast.LENGTH_LONG).show();
        }
    ...
    class createVenue extends AsyncTask<String, String, JSONObject> {
        ...
        protected JSONObject doInBackground(String... args) {
            ...
            if (networkConnection.isNetworkAvailable()) {
                ...
                // getting JSON Object
                // Note that create product url accepts POST method
                json = jsonParser.makeHttpRequest(ApplicationConstants.url_update_pg_position,
                        "POST", params);
